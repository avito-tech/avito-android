...
then
    ...
    readonly IMAGE_DIR=$dockerDir/emcee-apk-discoverer/hermetic
    readonly RELATIVE_DOCKERFILE=ci/docker/emcee-apk-discoverer/hermetic/Dockerfile
    ...
    Expected: ./publish_emcee_apk_discoverer <debug>

    Example: ./publish_emcee_apk_discoverer true
    "
    exit 1
fi
