...
1. Run `make draft_release version=<current release version> prev_version=<last release version>`. Insure you installed the ([`Github cli`](https://github.com/cli/cli))
