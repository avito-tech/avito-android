...
internal class GenerateOwnersTaskTest {
    ...
    internal fun `generate Owners file - file created and filled with data`(@TempDir projectDir: File) {
        ...
        val commandUuids =
            File(projectDir, "common/code-owners/src/main/kotlin/com/avito/android/ownership/CommandUuids.kt")

        assertThat(commandUuids.exists()).isFalse()
    }

    @Test
    internal fun `generate CommandUuids file - file created and filled with data`(@TempDir projectDir: File) {
        projectDir.dir("common/code-owners/src/main/kotlin/com/avito/android/ownership").file("Owners.kt")
        projectDir.dir(".bitbucket").file("CodeOwnersExclusions.csv").also {
            it.writeText(CODE_OWNERS_EXCLUSIONS_FILE_TEXT)
        }
        ...
        val file = File(projectDir, "common/code-owners/src/main/kotlin/com/avito/android/ownership/CommandUuids.kt")
        ...
        assertThat(file.readText()).isEqualTo(COMMAND_UUIDS_FILE_TEXT)
    }
    ...
    private companion object {
        ...
        private val COMMAND_UUIDS_FILE_TEXT = """
             ...
             */
            public object CommandUuids {
                public const val Speed: String = "1"
            }
