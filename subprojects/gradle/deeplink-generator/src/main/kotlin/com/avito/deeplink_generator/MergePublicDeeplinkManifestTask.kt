...
import com.avito.deeplink_generator.internal.parser.SchemeAwareDeeplinkFileParser
 ...
 */
@CacheableTask
public abstract class MergePublicDeeplinkManifestTask : DefaultTask() {

    /**
     * Input file with public deeplinks extracted from code.
     * Supported format is specified in [SchemeAwareDeeplinkFileParser].
     */
    @get:InputFile
    ...
    @get:InputFile
    @get:PathSensitive(PathSensitivity.RELATIVE)
    public abstract val inputManifest: RegularFileProperty
    ...
    private fun createPublicDeeplinkManifest(parentDir: File): File {
        val publicDeeplinks = SchemeAwareDeeplinkFileParser.parse(publicDeeplinksFromCode.get().asFile)
    ...
    public companion object {
        ...
        public fun taskName(variantName: String): String =
            "merge${variantName.capitalize()}PublicDeeplinkManifest"
    }
}
