...
internal abstract class SignTransformedBundleTask @Inject constructor(
    ...
    abstract val unsignedBundleFile: RegularFileProperty

    override fun unsignedFile(): File {
        return unsignedBundleFile.get().asFile
    }
