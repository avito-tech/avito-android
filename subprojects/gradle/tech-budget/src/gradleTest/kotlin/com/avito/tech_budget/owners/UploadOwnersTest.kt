...
internal class UploadOwnersTest {
    ...
    @Test
    fun `upload owners - actualOwnersProvider not provided - build failure`(@TempDir projectDir: File) {
        generateProject(projectDir, includeActualOwnersProvider = false)
    ...
    private fun generateProject(
        ...
        includeActualOwnersProvider: Boolean = true,
        ...
        buildGradleExtra = """
                ...
                ${if (includeCodeOwnership && includeActualOwnersProvider) codeOwnershipDiffExtension() else ""}
                techBudget {
