...
internal class ConfigurationCacheCompatibilityTest {
    ...
    fun `configuration with applied plugin`(@TempDir projectDir: File) {
         ...
         * - Plugin 'com.avito.android.build-verdict': registration of listener on 'Gradle.addListener' is unsupported
         * See https://docs.gradle.org/6.8/userguide/configuration_cache.html#config_cache:requirements:build_listeners
         * - Plugin 'com.avito.android.build-verdict': registration of listener on 'Gradle.buildFinished' is unsupported
         * See https://docs.gradle.org/6.8/userguide/configuration_cache.html#config_cache:requirements:build_listeners
         * - Plugin 'com.avito.android.build-verdict': registration of listener on 'Gradle.addBuildListener' is unsupported
         * See https://docs.gradle.org/6.8/userguide/configuration_cache.html#config_cache:requirements:build_listeners
         */
