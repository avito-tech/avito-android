...
internal class UploadCrashlyticsNativeSymbolsTasksProvider : CrashlyticsTaskProvider() {
    ...
    override fun taskProvider(
         ...
         */
        return ":$projectName:uploadCrashlyticsSymbolFile$buildVariantCapitalized"
    }
}
