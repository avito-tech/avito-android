...
public class RobolectricTestsPlugin : Plugin<Project> {

    override fun apply(target: Project) {
        val extension = target.extensions.create<RobolectricTestsExtension>("robolectricTests")
        configureTestTasks(target, extension)
    }

    private fun configureTestTasks(project: Project, extension: RobolectricTestsExtension) {
