...
internal class BuildCacheModuleTaskMissMetric(
    private val type: BuildCacheMetricType.ModuleTaskType,
    private val missesCount: Long,
) : BuildMetric.Graphite() {

    private val base: SeriesName = SeriesName.create("gradle.cache.remote.module.task.type.miss", multipart = true)
