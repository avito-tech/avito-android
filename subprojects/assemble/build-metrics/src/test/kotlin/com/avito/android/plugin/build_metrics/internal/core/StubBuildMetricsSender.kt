...
internal class StubBuildMetricsSender : BuildMetricSender {
    ...
    private val sentClickStreamEvents = mutableListOf<ClickStreamEvent>()
    ...
    override fun send(metric: BuildMetric) {
        when (metric) {
            ...
            is BuildMetric.ClickStream -> sentClickStreamEvents += metric.asClickStream()
        }
    }
    ...
    fun getSentClickStreamEvents(): List<ClickStreamEvent> = sentClickStreamEvents
}
