...
runInBuilder "set -e;
    ...
    ./gradlew :samples:test-app:instrumentationUi :samples:test-app-without-backward-compatibility:instrumentationUi :samples:test-app-screenshot-test:instrumentationUi ${GRADLE_ARGS}"
