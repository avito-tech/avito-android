...
android {
    ...
    defaultConfig {
        versionName = "1.0"
        versionCode = 1
        testInstrumentationRunner = "com.avito.android.composite.test.TestAppRunner"
...
dependencies {
    ...
    androidTestImplementation("com.avito.android:test-inhouse-runner:local")
    androidTestImplementation("com.avito.android:test-report:local")
    androidTestImplementation("com.avito.android:junit-utils:local")
    androidTestImplementation("com.avito.android:truth-extensions:local")
    androidTestImplementation("com.avito.android:test-annotations:local")
    androidTestImplementation("com.avito.android:report-viewer:local")
