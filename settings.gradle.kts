...
include(":subprojects:gradle:clickstream")
...
include(":subprojects:gradle:dependency-analysis")
include(":subprojects:gradle:demo-app-metrics")
...
include(":subprojects:common:retry-action")
...
include(":subprojects:test-runner:service-device")
