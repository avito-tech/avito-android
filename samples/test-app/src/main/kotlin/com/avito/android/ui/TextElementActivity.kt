...
class TextElementActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val longText = "Long text containing multiple links: link 1, link 2 and even long link which can have\nmultiple lines"
    ...
    private fun SpannableString.makeSpannable(text: String, textToSpan: String) {
        ...
        setSpan(clickableSpan, text.indexOf(textToSpan), text.indexOf(textToSpan) + textToSpan.length, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE)
    }
}